"""Hacktify scraper — Tier 3 (Playwright, SPA).

Leaderboard: https://hacktify.eu/en/leaderboard/
Profile: https://hacktify.eu/en/researcher/{username}
"""
...
LEADERBOARD_URL = "https://hacktify.eu/en/leaderboard/"
PROFILE_BASE = "https://hacktify.eu/en/researcher"


@register_scraper("hacktify")
class HacktifyScraper(PlaywrightScraper):
    platform_name = "hacktify"
    ...
    async def scrape_leaderboard(self, max_entries: int = 100) -> list[LeaderboardEntry]:
        ...
        try:
            ...
            log.info("hacktify_leaderboard_scraped", entries=len(entries))
    ...
    async def scrape_profile(self, username: str) -> tuple[PlatformProfile, ProfileSnapshot]:
        ...
        try:
            ...
            external_links = await self._get_all_links(page, exclude_domain="hacktify.eu")
