"""SafeHats scraper — Tier 3 (Playwright, SPA).
...
LEADERBOARD_URL = "https://app.safehats.com/member/leaderboard"
PROFILE_BASE = "https://app.safehats.com/member"


@register_scraper("safehats")
class SafehatsScraper(PlaywrightScraper):
    ...
    async def scrape_profile(self, username: str) -> tuple[PlatformProfile, ProfileSnapshot]:
        ...
        try:
            ...
            external_links = await self._get_all_links(page, exclude_domain="safehats.com")
