"""ComOlho scraper — Tier 3 (Playwright, SPA).

Leaderboard: https://cyber.comolho.com/researcher-community/
Profile: https://cyber.comolho.com/researcher/{username}
"""
...
LEADERBOARD_URL = "https://cyber.comolho.com/researcher-community/"
PROFILE_BASE = "https://cyber.comolho.com/researcher"


@register_scraper("comolho")
class ComolhoScraper(PlaywrightScraper):
    platform_name = "comolho"
    ...
    async def scrape_leaderboard(self, max_entries: int = 100) -> list[LeaderboardEntry]:
        ...
        try:
            ...
            log.info("comolho_leaderboard_scraped", entries=len(entries))
    ...
    async def scrape_profile(self, username: str) -> tuple[PlatformProfile, ProfileSnapshot]:
        ...
        try:
            ...
            external_links = await self._get_all_links(page, exclude_domain="comolho.com")
