"""SafeVuln scraper — Tier 3 (Playwright, SPA).

Leaderboard: https://safevuln.com/leaderboard
Profile: https://safevuln.com/researcher/{username}
"""
...
LEADERBOARD_URL = "https://safevuln.com/leaderboard"
PROFILE_BASE = "https://safevuln.com/researcher"


@register_scraper("safevuln")
class SafevulnScraper(PlaywrightScraper):
    platform_name = "safevuln"
    ...
    async def scrape_leaderboard(self, max_entries: int = 100) -> list[LeaderboardEntry]:
        ...
        try:
            ...
            log.info("safevuln_leaderboard_scraped", entries=len(entries))
    ...
    async def scrape_profile(self, username: str) -> tuple[PlatformProfile, ProfileSnapshot]:
        ...
        try:
            ...
            external_links = await self._get_all_links(page, exclude_domain="safevuln.com")
