"""WhiteHub scraper — Tier 3 (Playwright, SPA).

Leaderboard: https://whitehub.net/leaderboard
Profile: https://whitehub.net/researcher/{username}
"""
...
LEADERBOARD_URL = "https://whitehub.net/leaderboard"
PROFILE_BASE = "https://whitehub.net/researcher"


@register_scraper("whitehub")
class WhitehubScraper(PlaywrightScraper):
    platform_name = "whitehub"
    ...
    async def scrape_leaderboard(self, max_entries: int = 100) -> list[LeaderboardEntry]:
        ...
        try:
            ...
            log.info("whitehub_leaderboard_scraped", entries=len(entries))
    ...
    async def scrape_profile(self, username: str) -> tuple[PlatformProfile, ProfileSnapshot]:
        ...
        try:
            ...
            external_links = await self._get_all_links(page, exclude_domain="whitehub.net")
